...
> gml_Script_tutorial_vote (locals=0, argc=0)
:[1]
pushi.e 40
conv.i.v
...
conv.l.v
pushref.i 16777604
push.s "cards._tutorialVoteLeftDesc"@8443
conv.s.v
push.s "cards._tutorialVoteLeft"@8444
conv.s.v
...
pushi.e -9
pop.v.v [stacktop]self.tutorialVoteLeft
pushi.e 40
conv.i.v
call.i @@NewGMLArray@@(argc=1)
push.l 12
...
conv.l.v
pushref.i 16777605
push.s "cards._tutorialVoteRightDesc"@8445
conv.s.v
push.s "cards._tutorialVoteRight"@8446
conv.s.v
push.i [function]gml_Script_cCards
conv.i.v
call.i @@NewGMLObject@@(argc=8)
pushglb.v global.cards
pushi.e -9
pop.v.v [stacktop]self.tutorialVoteRight
b [5]

> gml_Script_anon@627@tutorial_vote@tutorial_vote (locals=3, argc=1)
:[2]
...
push.s "narrator._tutorialVoteDead3"@8447
conv.s.v
...
pushloc.v local._alignY
pushloc.v local._alignX
push.s "narrator._tutorialVoteDead2"@8448
conv.s.v
push.i [function]gml_Script_cDialogue
conv.i.v
call.i @@NewGMLObject@@(argc=5)
...
pushloc.v local._alignY
pushloc.v local._alignX
push.s "narrator._tutorialVoteDead1"@8449
conv.s.v
push.i [function]gml_Script_cDialogue
conv.i.v
call.i @@NewGMLObject@@(argc=5)
...
:[5]
push.i [function]gml_Script_anon@627@tutorial_vote@tutorial_vote
conv.i.v
pushi.e -1
conv.i.v
...
pushi.e -9
pop.v.v [stacktop]self.tutorialVote
exit.i

:[6]
push.i [function]gml_Script_tutorial_vote
conv.i.v
pushi.e -1
conv.i.v
call.i method(argc=2)
dup.v 0
pop.v.v self.tutorial_vote
popz.v
