...
> gml_Script_InputColorSupportedByDevice (locals=0, argc=1)
:[1]
...
dup.v 0 8
dup.v 0
push.v stacktop.__SupportedByDevice
callv.v 0
ret.v
...
:[13]
push.i [function]gml_Script_InputColorSupportedByDevice
conv.i.v
pushi.e -1
conv.i.v
call.i method(argc=2)
dup.v 0
pop.v.v self.InputColorSupportedByDevice
popz.v
