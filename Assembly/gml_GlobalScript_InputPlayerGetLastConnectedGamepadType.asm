...
> gml_Script_InputPlayerGetLastConnectedGamepadType (locals=0, argc=1)
:[1]
...
pushi.e -9
push.v [stacktop]self.__lastConnectedGamepadType
ret.v
...
:[13]
push.i [function]gml_Script_InputPlayerGetLastConnectedGamepadType
conv.i.v
pushi.e -1
conv.i.v
call.i method(argc=2)
dup.v 0
pop.v.v self.InputPlayerGetLastConnectedGamepadType
popz.v
