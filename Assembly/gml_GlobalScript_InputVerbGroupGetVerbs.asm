...
> gml_Script_InputVerbGroupGetVerbs (locals=2, argc=1)
:[1]
isstaticok.e
bt [3]
...
pop.v.v static._verbArray

:[3]
pushi.e 0
conv.i.v
push.v static._verbArray
...
:[9]
push.i [function]gml_Script_InputVerbGroupGetVerbs
conv.i.v
pushi.e -1
conv.i.v
call.i method(argc=2)
dup.v 0
pop.v.v self.InputVerbGroupGetVerbs
popz.v
