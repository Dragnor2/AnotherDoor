...
> gml_Script_scribble_font_bake_outline_8dir (locals=2, argc=5)
:[1]
...
:[8]
push.i [function]gml_Script_scribble_font_bake_outline_8dir
conv.i.v
pushi.e -1
conv.i.v
call.i method(argc=2)
dup.v 0
pop.v.v self.scribble_font_bake_outline_8dir
popz.v
