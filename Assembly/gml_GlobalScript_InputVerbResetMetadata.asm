...
> gml_Script_InputVerbResetMetadata (locals=1, argc=2)
:[1]
...
pushi.e -9
push.v [stacktop]self.__verbMetadataArray
pop.v.v local._verbMetadataArray
pushi.e -16
...
push.v arg.argument0
conv.v.i
pop.v.v [array]self._verbMetadataArray
exit.i

:[12]
push.i [function]gml_Script_InputVerbResetMetadata
conv.i.v
pushi.e -1
conv.i.v
call.i method(argc=2)
dup.v 0
pop.v.v self.InputVerbResetMetadata
popz.v
