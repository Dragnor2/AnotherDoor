...
> gml_Script_scribble_external_sprite_remove (locals=0, argc=1)
:[1]
isstaticok.e
bt [3]
...
:[4]
push.i [function]gml_Script_scribble_external_sprite_remove
conv.i.v
pushi.e -1
conv.i.v
call.i method(argc=2)
dup.v 0
pop.v.v self.scribble_external_sprite_remove
popz.v
