...
> gml_Script_InputPlayerSetMetadata (locals=0, argc=3)
:[1]
...
pushi.e -9
pop.v.v [stacktop]self.__metadata
exit.i

:[16]
push.i [function]gml_Script_InputPlayerSetMetadata
conv.i.v
pushi.e -1
conv.i.v
call.i method(argc=2)
dup.v 0
pop.v.v self.InputPlayerSetMetadata
popz.v
