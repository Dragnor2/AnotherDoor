...
> gml_Script_InputCursorGetSpeed (locals=0, argc=1)
:[1]
...
:[13]
push.i [function]gml_Script_InputCursorGetSpeed
conv.i.v
pushi.e -1
conv.i.v
call.i method(argc=2)
dup.v 0
pop.v.v self.InputCursorGetSpeed
popz.v
