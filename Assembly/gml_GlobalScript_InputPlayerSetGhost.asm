...
> gml_Script_InputPlayerSetGhost (locals=0, argc=2)
:[1]
...
pushi.e -9
pop.v.v [stacktop]self.__ghost
exit.i

:[12]
push.i [function]gml_Script_InputPlayerSetGhost
conv.i.v
pushi.e -1
conv.i.v
call.i method(argc=2)
dup.v 0
pop.v.v self.InputPlayerSetGhost
popz.v
