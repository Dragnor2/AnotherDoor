...
> gml_Script_InputVerbGetMetadata (locals=1, argc=3)
:[1]
...
conv.v.i
push.v [array]self.__verbMetadataArray
pop.v.v local._data
...
:[18]
push.i [function]gml_Script_InputVerbGetMetadata
conv.i.v
pushi.e -1
conv.i.v
call.i method(argc=2)
dup.v 0
pop.v.v self.InputVerbGetMetadata
popz.v
