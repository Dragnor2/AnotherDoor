...
> gml_Script_InputPlayerGetInactive (locals=0, argc=2)
:[1]
...
pushi.e -9
push.v [stacktop]self.__lastInputTime
sub.v.v
...
:[15]
push.i [function]gml_Script_InputPlayerGetInactive
conv.i.v
pushi.e -1
conv.i.v
call.i method(argc=2)
dup.v 0
pop.v.v self.InputPlayerGetInactive
popz.v
