...
> gml_Script_InputPlugInGamepadSetType (locals=1, argc=2)
:[1]
isstaticok.e
bt [3]
...
pushloc.v local._deviceStruct
pushi.e -9
pop.v.v [stacktop]self.__type
exit.i

:[11]
push.i [function]gml_Script_InputPlugInGamepadSetType
conv.i.v
pushi.e -1
conv.i.v
call.i method(argc=2)
dup.v 0
pop.v.v self.InputPlugInGamepadSetType
popz.v
