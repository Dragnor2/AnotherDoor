...
> gml_Script_InputTriggerEffectSetStrength (locals=1, argc=2)
:[1]
...
call.i gml_Script_InputTriggerEffectSetStrength(argc=2)
popz.v
push.v local._i
push.e 1
add.i.v
...
:[19]
push.i [function]gml_Script_InputTriggerEffectSetStrength
conv.i.v
pushi.e -1
conv.i.v
call.i method(argc=2)
dup.v 0
pop.v.v self.InputTriggerEffectSetStrength
popz.v
