...
> gml_Script_InputPressedMany (locals=4, argc=2)
:[1]
...
call.i gml_Script_InputPressedMany(argc=2)
conv.v.b
bf [14]
...
:[31]
push.i [function]gml_Script_InputPressedMany
conv.i.v
pushi.e -1
conv.i.v
call.i method(argc=2)
dup.v 0
pop.v.v self.InputPressedMany
popz.v
