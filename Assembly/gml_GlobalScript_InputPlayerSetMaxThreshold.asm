...
> gml_Script_InputPlayerSetMaxThreshold (locals=0, argc=3)
:[1]
...
push.l 0
conv.l.i
pop.v.v [array]self.__thresholdMaxArray
push.v arg.argument1
pushi.e -6
push.l 1
conv.l.i
...
:[16]
push.i [function]gml_Script_InputPlayerSetMaxThreshold
conv.i.v
pushi.e -1
conv.i.v
call.i method(argc=2)
dup.v 0
pop.v.v self.InputPlayerSetMaxThreshold
popz.v
