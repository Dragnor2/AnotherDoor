...
> gml_Script_InputMotionIsCalibrated (locals=1, argc=1)
:[1]
...
pushloc.v local._deviceStruct
pushi.e -9
push.v [stacktop]self.__isCalibrated
ret.v
...
:[15]
push.i [function]gml_Script_InputMotionIsCalibrated
conv.i.v
pushi.e -1
conv.i.v
call.i method(argc=2)
dup.v 0
pop.v.v self.InputMotionIsCalibrated
popz.v
