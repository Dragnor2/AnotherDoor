...
> gml_Script_InputIconGet (locals=1, argc=3)
:[1]
...
push.v arg.argument2
call.i gml_Script_InputPlayerGetLastConnectedGamepadType(argc=1)
...
call.i gml_Script_InputIconGetDirect(argc=3)
ret.v
...
:[13]
push.i [function]gml_Script_InputIconGet
conv.i.v
pushi.e -1
conv.i.v
call.i method(argc=2)
dup.v 0
pop.v.v self.InputIconGet
popz.v
