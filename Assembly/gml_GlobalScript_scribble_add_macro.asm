...
> gml_Script_scribble_add_macro (locals=1, argc=2)
:[1]
isstaticok.e
bt [3]
...
conv.s.v
push.v arg.argument0
push.s "Macro names should be strings.\n(Input to script was \""@7730
conv.s.v
...
push.v arg.argument0
add.v.s
push.s "\" has already been defined as a typist event"@7735
add.s.v
call.i gml_Script___scribble_trace(argc=1)
popz.v
exit.i
...
:[25]
push.i [function]gml_Script_scribble_add_macro
conv.i.v
pushi.e -1
conv.i.v
call.i method(argc=2)
dup.v 0
pop.v.v self.scribble_add_macro
popz.v
