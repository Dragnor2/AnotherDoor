...
> gml_Script_InputTriggerEffectGetStrength (locals=0, argc=1)
:[1]
...
pushi.e -9
push.v [stacktop]self.__strength
ret.v
...
:[13]
push.i [function]gml_Script_InputTriggerEffectGetStrength
conv.i.v
pushi.e -1
conv.i.v
call.i method(argc=2)
dup.v 0
pop.v.v self.InputTriggerEffectGetStrength
popz.v
